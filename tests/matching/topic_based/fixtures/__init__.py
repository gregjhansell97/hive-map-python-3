...
import tests.matching.topic_based.fixtures.algo_fixtures as algo_fixtures
...
base_fixtures |= algo_fixtures.base_fixtures
...
impl_fixtures |= algo_fixtures.impl_fixtures
